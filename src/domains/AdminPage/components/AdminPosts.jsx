...
const AdminPosts = () => {
  ...
  const filteredPosts = posts.filter(post => {
    ...
    if (filter === "Q&A" && post.direction === "FORUM" && post.projectId === null) return true;
    if (filter === "FREE" && post.direction === "NONE" && post.projectId === null) return true;
    return false;
  });
  if (loading) {
  ...
  return (
    ...
    <TableContainer component={Paper} sx={{ maxWidth: 900, margin: "20px auto", padding: 2 }}>
